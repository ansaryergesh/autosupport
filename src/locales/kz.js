export default {
  ...
  oldTickets: 'Өңделген  тикеттер',
  processed: 'Өңделгді',
  processedBy: 'Кім өңдеді',
  processedWhen: 'Қашан өңделді',
  noData: 'Ақпарат жоқ',
  ...
  searchTickets: 'Тикеттер бойынша іздеу',
  toggleTickets: 'Тикет жіберу мүмкіндігі',
  search: 'Іздеу',
  ...
  actions: {
    ...
    downloadAnswers: 'Барлық жауаптарды жүктеу',
  ...
  userProfile: {
    ...
    userProfileSelector: 'Пайдаланушы параметрлері',
    accountSettingsSelector: 'Аккаунт параметрлері',
    accountDataTitle: 'Аккаунт деректері',
    idLabel: 'Сәйкестендіру нөмірі',
    emailLabel: 'Пошта',
    languageKeyLabel: 'Тіл кілті',
    creatorLabel: 'Жаратушы',
    ...
    saveButton: 'Сақтау',
    userDataTitle: 'Пайдаланушы деректері',
    loginLabel: 'Логин',
    firstNameLabel: 'Аты',
    lastNameLabel: 'Тегі',
  ...
  invalid: {
    'user-not-found-exception': 'Пайдаланушы табылмады',
    'not-found-exception': 'Табылмады',
    'email-is-already-in-use': 'Пошта бұрыннан пайдаланылуда',
    password: 'Қате кілтсөз',
    'organization-not-found': 'Ұйым табылмады',
    'login-already-used': 'Пошта бұрыннан пайдаланылуда',
    'invalid-query-syntax': 'Сұрау синтаксисі жарамсыз',
    'user-is-not-authenticated': 'Пайдаланушы аутентификациялауға жеткізілмеді',
    'can-not-register-user-with-super-admin-role':
      'Супер администратор рөлімен пайдаланушыны тіркеу мүмкін емес',
    'can-not-delete-user-with-super-admin-role':
      'Супер администратор рөлімен пайдаланушыны жою мүмкін емес',
    'no-user-was-found-for-this-activation-key': 'Бұл активация кілті үшін пайдаланушы табылмады',
    'no-user-was-found-for-this-deactivation-key': 'Бұл деактивация кілті үшін пайдаланушы табылмады',
    'photo-not-deleted': 'Фотосурет жойылмады',
    "email-or-password": 'Жарамсыз пошта немесе кілтсөз',
    'email-domain-does-not-end-with-@ffin.kz': 'Почта соңы @ffin.kz - пен біту қажет '
  },
