export default {
  ...
  invalid: {
    ...
    'email-is-already-in-use': 'Почта уже используется',
    password: 'Неверный пароль',
    'organization-not-found': 'Организация не найдена',
    'login-already-used': 'Логин уже используется',
    'invalid-query-syntax': 'Неверный синтаксис запроса',
    'user-is-not-authenticated': 'Пользователь не аутентифицирован',
    ...
    'no-user-was-found-for-this-activation-key': 'Пользователь не найден для этого ключа активации',
    'no-user-was-found-for-this-deactivation-key':
      'Пользователь не найден для этого ключа деактивации',
    'photo-not-deleted': 'Фотография не удалена',
    'email-or-password': 'Неверная почта или пароль',
    'email-domain-does-not-end-with-@ffin.kz': 'Почта должна заканчиваться @ffin.kz'
  },
